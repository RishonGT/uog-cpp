...
df.to_csv('assignments/assignment-02/Python LR/data/mnist_full.csv', index=False, header=False)
...
n_values = [1000, 300]
filenames = ["assignments/assignment-02/Python LR/data/mnist_mini.csv", "assignments/assignment-02/Python LR/data/mnist_micro.csv"]
