...
In order to understand the project better, I suggest you to read the description in the following order:
1. Read the whole description once to get a general idea about the project. Filename `01-description.html` and `01-description.pdf` are provided for this purpose. You don't have to understand everything in the first reading. Just try to get a general idea about the project.
2. Read the implementation using scikit-learn in Python. This will give you the idea about how to use the two regression models in Python and what are the expected results. The C++ implementation will mimic the Python implementation, so it is important to understand the Python implementation first. Filename `02-sklearn-implementation.html` and `02-sklearn-implementation.pdf` are provided for this purpose.
3. Read the mathematics behind the scene to understand the mathematical formulation of the two regression models and the gradient descent method. This will help you to understand how to implement the two regression models in C++. Filename `03-maths.html` and `03-maths.pdf` are provided for this purpose.
4. Then, you should revisit the task description `01-description.qmd` to understand what you need to do for the assignment.
