...
```{.cpp #lst-fix-innocent-program-01 lst-cap="Reorder the function definitions to fix the innocent program"}
...
```{.cpp #lst-forward-declration lst-cap="Use forward decleration to fix the innocent program"}
